...
export const projects = Array.from({ length: 100 }, (_, i) => ({
  ...
  fullDescription: `This project represents a significant milestone in web development, combining cutting-edge technologies with intuitive design principles. The application serves as a comprehensive solution for [specific industry/purpose], addressing key challenges and providing innovative features that set it apart from conventional alternatives.

Our team employed a modern tech stack to ensure optimal performance, scalability, and user experience. The architecture follows best practices in software development, with a strong emphasis on code quality, maintainability, and security.`,
  ...
  technologies: ["React.js", "TypeScript", "Node.js", "PostgreSQL", "Docker"],
  screenshots: [
